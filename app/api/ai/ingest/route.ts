...
const PROJECT_SYSTEM = `You are the document-ingestion agent of ASSETMAX Global, an international marketplace for industrial assets and megaprojects. You receive a technical report, information memorandum or presentation for an asset that will be listed for sale or investment.
...
const COMMODITY_SYSTEM = `You are the document-ingestion agent of ASSETMAX Global's physical commodities marketplace. You receive a technical sheet, certificate of analysis or offer sheet for a physical commodity.
